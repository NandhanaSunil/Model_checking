...
#ifndef YY_YY_CTL_TAB_H_INCLUDED
# define YY_YY_CTL_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_CTL_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "OR", "AND", "NOT", "IMPLIES", "EX",
  "EG", "EU", "T", "F", "LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "AG",
  "AF", "AX", "A", "BEG", "END", "EF", "E", "U", "PROP", "$accept",
  "formula", "expression", YY_NULLPTR
};
#endif
...
{
      35,    54,    54,    54,   -12,   -12,    54,    54,    54,    54,
      54,    54,    54,   -11,   -12,     4,    86,    86,    86,    86,
      81,    86,    86,    86,    77,    13,    86,    54,   -12,    54,
      54,    54,   -12,   -10,   -12,     9,    86,    86,    86,    54,
      54,    17,    21,   -12,   -12
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     0,     0,     0,    12,     0,     3,     8,     9,    10,
       0,    15,    16,    17,     0,     0,    19,     0,     1,     0,
       0,     0,    11,     0,     2,     0,     4,     5,     6,     0,
       0,     0,     0,    18,     7
};
...
{
      17,    18,    19,    27,    28,    20,    21,    22,    23,    24,
      25,    26,    29,    30,    39,    31,    29,    30,     0,    31,
      29,    30,     0,    31,    29,    30,    35,    31,    36,    37,
      38,     0,    43,    40,    34,     0,    44,     0,    41,    42,
       1,     0,     2,     3,     0,     4,     5,     6,     0,     0,
       0,     7,     8,     9,    10,    11,     0,    12,    13,     1,
      14,     2,     3,     0,     4,     5,     6,     0,     0,     0,
       7,     8,     9,    10,     0,     0,    12,    13,     0,    14,
      29,    30,     0,    31,    29,    30,     0,    31,     0,    29,
      30,    33,    31,     0,    32
};

static const yytype_int8 yycheck[] =
{
       1,     2,     3,    14,     0,     6,     7,     8,     9,    10,
      11,    12,     3,     4,    24,     6,     3,     4,    -1,     6,
       3,     4,    -1,     6,     3,     4,    27,     6,    29,    30,
      31,    -1,    15,    24,    21,    -1,    15,    -1,    39,    40,
       5,    -1,     7,     8,    -1,    10,    11,    12,    -1,    -1,
      -1,    16,    17,    18,    19,    20,    -1,    22,    23,     5,
      25,     7,     8,    -1,    10,    11,    12,    -1,    -1,    -1,
...
{
       0,     5,     7,     8,    10,    11,    12,    16,    17,    18,
      19,    20,    22,    23,    25,    27,    28,    28,    28,    28,
      28,    28,    28,    28,    28,    28,    28,    14,     0,     3,
       4,     6,    13,    14,    21,    28,    28,    28,    28,    24,
      24,    28,    28,    15,    15
};
...
yyreduce:
  ...
  case 2:
#line 19 "CTL.y"
                             { (yyval.node) = new_node("FORMULA", (yyvsp[-1].node), NULL); printtree((yyval.node)); print_formula((yyvsp[-1].node)); check((yyvsp[-1].node)); freetree((yyval.node)); }
#line 1361 "CTL.tab.c"
    break;

  case 3:
#line 20 "CTL.y"
                             { (yyval.node) = new_node("FORMULA", (yyvsp[0].node), NULL); printtree((yyval.node)); print_formula((yyvsp[0].node)); freetree((yyval.node)); }
#line 1367 "CTL.tab.c"
    break;

  case 4:
#line 23 "CTL.y"
                                                      { (yyval.node) = new_node("|", (yyvsp[-2].node), (yyvsp[0].node)); printtree((yyval.node)); process_or((yyval.node),&ks);}
#line 1373 "CTL.tab.c"
    break;

  case 5:
#line 24 "CTL.y"
                                                      { Node* negp = new_node("~", (yyvsp[-2].node), NULL); process_neg(negp, &ks);
                                                        Node* negq = new_node("~", (yyvsp[0].node), NULL); process_neg(negq, &ks);
                                                        Node* negpORnegq = new_node("|", negp, negq); process_or(negpORnegq, &ks);
                                                        (yyval.node) = new_node("~", negpORnegq, NULL); printtree((yyval.node)); process_neg((yyval.node), &ks);}
#line 1382 "CTL.tab.c"
    break;
...
#line 28 "CTL.y"
                                                      { Node* negp = new_node("~", (yyvsp[-2].node), NULL); process_neg(negp, &ks);
                                                        (yyval.node) = new_node("|", negp, (yyvsp[0].node)); printtree((yyval.node)); process_or((yyval.node), &ks);}
#line 1389 "CTL.tab.c"
    break;

  case 7:
#line 30 "CTL.y"
                                                      { (yyval.node) = new_node("EU", (yyvsp[-3].node), (yyvsp[-1].node)); printtree((yyval.node)); process_EU((yyval.node), &ks);}
#line 1395 "CTL.tab.c"
    break;

  case 8:
#line 31 "CTL.y"
                                                      { (yyval.node) = new_node("~", (yyvsp[0].node), NULL); printtree((yyval.node)); process_neg((yyval.node), &ks);}
#line 1401 "CTL.tab.c"
    break;

  case 9:
#line 32 "CTL.y"
                                                      { (yyval.node) = new_node("EX", (yyvsp[0].node), NULL); printtree((yyval.node)); process_EX((yyval.node), &ks);}
#line 1407 "CTL.tab.c"
    break;

  case 10:
#line 33 "CTL.y"
                                                      { (yyval.node) = new_node("EG", (yyvsp[0].node), NULL); printtree((yyval.node)); process_EG((yyval.node), &ks);}
#line 1413 "CTL.tab.c"
    break;
